...
class SignUpForBrand extends StatefulWidget {
  const SignUpForBrand({Key? key}) : super(key: key);

  @override
  State<SignUpForBrand> createState() => _SignUpForBrandState();
}

class _SignUpForBrandState extends State<SignUpForBrand> {
